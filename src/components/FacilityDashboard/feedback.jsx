...
export default function Feedback() {
  ...
  return (
    <div className="flex flex-col h-full max-h-[calc(100vh-120px)] bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
      {/* Enhanced Header */}
        ...
        {!activeChat ? (
          ...
          <div className="flex items-center justify-center h-full">
            <div className="text-center text-gray-500 max-w-md">
              ...
              <p className="text-sm text-gray-500 mb-4">We're excited to help you. Send a message below to get started.</p>
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <p className="text-xs text-blue-700">💡 Tip: Be specific about your issue for faster assistance</p>
              </div>
            </div>
          </div>
        ) : (
                      ...
                      <div key={index} className={`flex ${isAdmin ? 'justify-start' : 'justify-end'}`}>
                        <div className={`flex max-w-xs lg:max-w-md ${isAdmin ? 'flex-row' : 'flex-row-reverse'}`}>
                          ...
                          <div className="flex flex-col">
                            ...
                            {/* {isAdmin && (
                              <div className="text-xs font-semibold mb-1 text-primarysolid px-1">
                                CareFindr Support
                              </div>
                            )} */}
