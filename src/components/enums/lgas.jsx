export const lgas = {
    ...
    Adamawa: [
      'Demsa', 'Fufure', 'Ganye', 'Guyuk', 'Girei', 'Gombi', 'Hong', 'Jada', 'Lamurde',
    ...
    Ebonyi: [
      'Abakaliki', 'Afikpo', 'Edda', 'Ebonyi', 'Ezza North', 'Ezza South', 'Ikwo',
      'Ishielu', 'Ivo', 'Izzi', 'Ohaozara', 'Ohaukwu', 'Onicha'
    ],
    Edo: [
      'Akoko-Edo', 'Benin', 'Egor', 'Esan Central', 'Esan North-East', 'Esan South-East',
    ...
    Jigawa: [
      'Auyo', 'Babura', 'Birniwa', 'Birnin Kudu', 'Buji', 'Dutse', 'Gagarawa', 'Garki',
    ...
    Kogi: [
      ...
      'Kabba/Bunu', 'Mopa-Muro', 'Ijumu', 'Yagba West', 'Yagba East', 'Okene', 'Okehi',
      'Lokoja', 'Isanlu', 'Olamaboro', 'Omala'
    ],
    Kwara: [
      'Ekiti', 'Ifelodun', 'Ilorin East', 'Ilorin West', 'Irepodun', 'Isin', 'Kaiama',
      'Moro', 'Offa', 'Oke Ero', 'Oyun', 'Pategi', 'Baruten', 'Asa', 'Edu', 'Ilorin South'
    ],
    Lagos: [
    ...
    Nasarawa: [
      ...
      'Nasarawa', 'Nasarawa Eggon', 'Wamba', 'Toto'
    ],
    Niger: [
    ...
    Ogun: [
      'Abeokuta North', 'Abeokuta South', 'Ado-Odo/Ota', 'Ewekoro', 'Ifo', 'Ijebu North',
      'Ijebu North East', 'Ijebu Ode', 'Ijebu East', 'Ilishan-Remo', 'Ikenne', 'Imeko Afon',
      'Ipokia', 'Obafemi Owode', 'Odeda', 'Odogbolu', 'Ogun Waterside', 'Remo North',
      'Shagamu', 'Yewa North', 'Yewa South'
    ],
    Ondo: [
      'Akoko North-East', 'Akoko North-West', 'Akoko South-East', 'Akoko South-West',
      'Akure North', 'Akure South', 'Ese Odo', 'Ifedore', 'Idanre', 'Ilaje',
      'Ile-Oluji/Okeigbo', 'Irele', 'Odigbo', 'Okitipupa', 'Ondo West', 'Ondo East',
      'Ose', 'Owo'
    ],
    Osun: [
      ...
      'Ife North', 'Ife South', 'Ifedayo', 'Ifelodun', 'Isokan', 'Obokun', 'Irewole',
      'Ola-Oluwa', 'Olorunda', 'Ilesa West', 'Ilesa East', 'Odo-Otin', 'Ila', 'Ori-Ade',
      'Orolu', 'Irepodun', 'Iwo', 'Osogbo'
    ],
    Oyo: [
      'Afijio', 'Ibadan North', 'Ibadan North-East', 'Ibadan North-West', 'Ibadan South-East',
      'Ibadan South-West', 'Ibarapa Central', 'Ibarapa East', 'Ibarapa North', 'Ido',
      'Irepo', 'Iwajowa', 'Ogbomosho North', 'Ogbomosho South', 'Ogo Oluwa', 'Olorunsogo',
      'Oluyole', 'Ona Ara', 'Orelope', 'Orire', 'Atisbo', 'Saki West', 'Saki East',
      'Egbeda', 'Lagelu', 'Atiba', 'Oyo East', 'Oyo West'
    ],
    Plateau: [
      'Barkin Ladi', 'Bassa', 'Bokkos', 'Jos East', 'Jos North', 'Jos South', 'Kanam',
      'Kanke', 'Langtang North', 'Langtang South', 'Mangu', 'Mikang', 'Pankshin',
      'Quaran Pan', 'Riyom', 'Shendam', 'Wase'
    ],
    Rivers: [
      'Abua-Odual', 'Ahoada East', 'Ahoada West', 'Akuku Toru', 'Andoni', 'Asari Toru',
      'Bonny', 'Degema', 'Eleme', 'Emohua', 'Etche', 'Gokana', 'Ikwerre', 'Khana',
      'Obio-Akpor', 'Ogba-Egbema-Ndoni', 'Ogu-Bolo', 'Okirika', 'Omuma', 'Opobo-Nkoro',
